...
import { SeoData } from '@app/shared/interfaces/seo-data';
...
export class SeoService {
	...
	updateSeo(data: SeoData): void {
		...
		this.meta.updateTag({
			property: 'og:image',
			content: data.ogImage || this.DEFAULT_OG_IMAGE,
		});
	...
	private removeArticleTags(): void {
		['article:published_time', 'article:modified_time', 'article:author'].forEach(
			(property) => {
